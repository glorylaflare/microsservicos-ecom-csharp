...
public class AuthenticateUserCommandHandler : IRequestHandler<AuthenticateUserCommand, Result<TokenResponse>>
{
    private readonly IValidator<AuthenticateUserCommand> _validator;
    private readonly IAuthService _authService;
    private readonly Serilog.ILogger _logger;

    public AuthenticateUserCommandHandler(IValidator<AuthenticateUserCommand> validator, IAuthService authService)
    {
        _validator = validator;
        _authService = authService;
        _logger = Log.ForContext<AuthenticateUserCommandHandler>();
    }
